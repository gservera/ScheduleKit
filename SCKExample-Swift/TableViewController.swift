...
final class TableViewController: NSViewController {
    ...
    @IBAction func createNewEvent(_ sender: Any) {
        let testEvent = TestEvent(kind: .generic, user: EventEngine.shared.users[0], title: "New event", duration: 60, date: Calendar.current.date(bySettingHour: 8, minute: 0, second: 0, of: Date())!)
