...
class SCKUnavailableTimeRangesTests: XCTestCase {
    ...
    func testArchiving() {
        ...
        guard let unarchived = NSKeyedUnarchiver.unarchiveObject(with: data) as? SCKUnavailableTimeRange else {
    ...
    func testMatchingNoWeekday() {
        let locked = SCKUnavailableTimeRange(weekday: -1, startHour: 10, startMinute: 30, endHour: 12, endMinute: 30)!
        ...
        let matches = locked.matchingOccurrences(in: interval)
    ...
    func testMatchingWithWeekday() {
        ...
        let locked = SCKUnavailableTimeRange(weekday: 2, startHour: 10, startMinute: 30, endHour: 12, endMinute: 30)!
